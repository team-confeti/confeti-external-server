...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleConfetiException(ConfetiException e, HttpServletRequest request) {
        request.setAttribute("exception", e);
    ...
    public ResponseEntity<?> handleRequestNotPermittedException(RequestNotPermitted e, HttpServletRequest request) {
        request.setAttribute("exception", e);
